...
GRANT SELECT, INSERT, UPDATE, DELETE ON LESSON TO PUBLIC;
GRANT SELECT, INSERT, UPDATE, DELETE ON PASS TO PUBLIC;
GRANT SELECT, INSERT, UPDATE, DELETE ON LESSON_LOG TO PUBLIC;
GRANT SELECT, INSERT, UPDATE, DELETE ON TRAIL TO PUBLIC;
GRANT SELECT, INSERT, UPDATE, DELETE ON LIFT TO PUBLIC;
GRANT SELECT, INSERT, UPDATE, DELETE ON LIFT_LOG TO PUBLIC;
GRANT SELECT, INSERT, UPDATE, DELETE ON INVENTORY TO PUBLIC;
GRANT SELECT, INSERT, UPDATE, DELETE ON RENTAL_LOG TO PUBLIC;
